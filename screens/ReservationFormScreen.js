      ...
      <ScrollView showsVerticalScrollIndicator={false} automaticallyAdjustKeyboardInsets={true} keyboardDismissMode="interactive">
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={s.dateRow} delayContentTouches={false}>
          {availableDays.map(d => (
            ...
            >
              <Text style={[s.dateDayName, date === d.value && s.dateTxtOn, d.isToday && date !== d.value && { color: colors.primary }]}>
              ...
              {d.isWeekend && <View style={[s.weekendDot, date === d.value && { backgroundColor: colors.primary }]} />}
            </TouchableOpacity>
          ))}
        </ScrollView>
            ...
            >
              ...
              {occasion === o.id && (
                <View style={s.occasionCheck}>
                  <Text style={{ color: colors.primary, fontSize: typography.size.xs, fontWeight: typography.weight.semibold }}>✓</Text>
                </View>
              )}
            </TouchableOpacity>
          ))}
...
const s = StyleSheet.create({
  ...
  sectionNumTxt:   { fontFamily: typography.bodySemibold, color: colors.text, fontSize: typography.size.sm },
  sectionLabel:    { fontFamily: typography.body, color: colors.textMuted, fontSize: typography.size.sm, letterSpacing: 3 },
  sectionLabelDone:{ color: colors.green },
  sectionChosen:   { fontFamily: typography.bodyMedium, color: colors.textMuted, fontSize: typography.size.caption },
  optLabel:        { fontFamily: typography.body, color: colors.textDim, fontSize: typography.size.sm, letterSpacing: 3 },
  optSub:          { fontFamily: typography.body, color: colors.textDim, fontSize: typography.size.xs, letterSpacing: 1 },
  charCount:       { fontFamily: typography.body, color: colors.textDim, fontSize: typography.size.sm },
  ...
  dateCardOn:      { backgroundColor: colors.primary, borderColor: colors.primary },
  dateCardToday:   { borderColor: colors.primary },
  ...
  slotTxt:         { fontFamily: typography.body, color: colors.textMuted, fontSize: typography.size.heading3 },
  slotTxtOn:       { color: colors.resa, fontFamily: typography.bodySemibold },
  ...
  slotBadgeTxt:    { fontFamily: typography.body, color: colors.primary, fontSize: typography.size.xs },
  ...
  noteInput: { fontFamily: typography.body, color: colors.text, fontSize: typography.size.bodyLg, padding: spacing.xl, minHeight: 90, textAlignVertical: 'top' },
