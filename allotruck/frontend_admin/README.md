# AlloTruck — Console d'administration

Tableau de bord web permettant à un administrateur AlloTruck de valider les dossiers
...
| -------------- | ------------------------------------ | ------------------------------- |
| `VITE_API_URL` | URL de base de l'API AlloTruck       | `http://localhost:4000/api`     |
...
(`.github/workflows/allotruck.yml`), avant le build de production.
