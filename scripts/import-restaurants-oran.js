#!/usr/bin/env node
// Import des restaurants d'Oran (recherche web -- TripAdvisor + sites d'annuaire locaux,
...
//     critere que l'exclusion Alger) : "Bekhchi's" (deux adresses differentes trouvees,
//     Akid Lotfi ET Ibn Sina, aucune confirmee comme la bonne), "Maharaja Indian
//     Restaurant" (deux emplacements distincts, Trait d'Union et Akid Lotfi), "Restaurant
//     Les Gazelles" (en realite a Arzew, hors d'Oran, malgre son classement dans la liste
//     TripAdvisor "Oran Province").
//
// Usage : SUPABASE_SERVICE_ROLE_KEY=xxx node scripts/import-restaurants-oran.js
...
if (!SERVICE_ROLE_KEY) {
  ...
  console.error('Usage : SUPABASE_SERVICE_ROLE_KEY=xxx node scripts/import-restaurants-oran.js');
  process.exit(1);
}
...
const DATA_PATH = path.join(__dirname, '../data/top_restaurants_oran.json');
