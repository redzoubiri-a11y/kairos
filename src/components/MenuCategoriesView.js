...
const c = StyleSheet.create({
  ...
  addBtn:    { width: 46, height: 46, borderRadius: radius.xl, backgroundColor: colors.goldSoft, borderWidth: 1, borderColor: alpha(colors.gold, 0.4), alignItems: 'center', justifyContent: 'center', shadowColor: colors.shadow, shadowOpacity: 0.35, shadowRadius: 8, shadowOffset: { width: 0, height: 0 }, elevation: 4 },
