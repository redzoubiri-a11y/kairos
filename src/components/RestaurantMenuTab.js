...
const s = StyleSheet.create({
  ...
  popularTxt:  { color: colors.gold, fontSize: typography.size.xs, fontWeight: typography.weight.medium },
  desc:        { color: colors.textMuted, fontSize: typography.size.caption, lineHeight: 16 },
  priceBox:    { alignItems: 'flex-end', minWidth: 55 },
  price:       { color: colors.primary, fontSize: typography.size.heading3, fontWeight: typography.weight.semibold },
