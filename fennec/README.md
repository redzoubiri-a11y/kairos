...
fennec/
  ...
  app/                        # PWA réelle, branchée sur src/*.mjs (pas une maquette)
    ...
    bemSprint.html/.mjs        # BEM Sprint — BS1/BS2/BS3 (?week=1/2/3 ou onglets), vrai écran — voir plus bas
    bemSprintBS1/2/3.json      # texte support + 7 items par semaine, écrits à la main (pas générés)
...
**BEM Sprint — trois semaines réelles (BS1, BS2, BS3).** `fennec/app/bemSprint.html`
...
les onglets BS1/BS2/BS3 en haut de l'écran (rechargent la page avec le
...
dérivation nom/adjectif (préfixe *un-*, suffixes *-ness/-ful*). Lien retour vers
...
avant d'investir dans l'une des deux architectures. BS4-BS8 ne sont pas
intégrés. Validé en navigateur réel : score exact (7/7 sur BS1, BS2 et BS3
