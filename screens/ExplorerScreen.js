...
const s = StyleSheet.create({
  ...
  modeBtnOn:   { backgroundColor: colors.goldSoft, borderColor: colors.gold, shadowColor: colors.shadow, shadowOpacity:0.35, shadowRadius:10, shadowOffset:{ width:0, height:0 }, elevation:5 },
  ...
  selRating:  { color: colors.resa, fontSize:typography.size.body, fontWeight:'500' },
