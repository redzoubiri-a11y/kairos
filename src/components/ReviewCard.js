...
const s = StyleSheet.create({
  ...
  replyBtn:       { backgroundColor: colors.primaryDim, borderRadius: radius.lg, padding: spacing.md, alignItems: 'center', borderWidth: 1, borderColor: colors.primary, shadowColor: colors.shadow, shadowOpacity: 0.25, shadowRadius: 8, shadowOffset: { width: 0, height: 0 }, elevation: 3 },
  ...
  saveBtn:        { flex: 2, padding: spacing.md, borderRadius: radius.lg, alignItems: 'center', backgroundColor: colors.noir, shadowColor: colors.shadow, shadowOpacity: 0.4, shadowRadius: 12, shadowOffset: { width: 0, height: 0 }, elevation: 6 },
  saveTxt:        { color: colors.onDark, fontSize: typography.size.body, fontWeight: typography.weight.bold },
});
