...
const s = StyleSheet.create({
  ...
  name:          { color: colors.text, fontFamily: typography.bodyMedium, fontSize: typography.size.subheading, fontWeight: typography.weight.medium },
  nameDim:       { color: colors.textDim },
  desc:          { color: colors.textDim, fontFamily: typography.body, fontSize: typography.size.caption, lineHeight: 16 },
  price:         { color: colors.primary, fontFamily: typography.bodyBold, fontSize: typography.size.subheading, fontWeight: typography.weight.bold, flexShrink: 0 },
  ...
  indispoTxt:    { color: colors.red, fontFamily: typography.bodySemibold, fontSize: typography.size.xs, fontWeight: typography.weight.semibold },
  ...
  dotdTxt:       { color: colors.gold, fontFamily: typography.bodySemibold, fontSize: typography.size.xs, fontWeight: typography.weight.semibold },
  ...
  editTxt:       { color: colors.blue, fontFamily: typography.bodySemibold, fontSize: typography.size.body, fontWeight: typography.weight.semibold },
