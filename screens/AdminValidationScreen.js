...
const s = StyleSheet.create({
  ...
  headerTitle: { flex: 1, color: colors.text, fontFamily: typography.display, fontSize: typography.size.heading2, letterSpacing: 2, textAlign: 'center' },
  ...
  deniedTitle: { color: colors.text, fontFamily: typography.body, fontSize: typography.size.heading1 },
  deniedSub:   { color: colors.textMuted, fontFamily: typography.body, fontSize: typography.size.body, textAlign: 'center' },

  emptyWrap:  { alignItems: 'center', paddingVertical: spacing.section * 2, gap: spacing.md },
  emptyTitle: { color: colors.text, fontFamily: typography.body, fontSize: typography.size.heading2 },
  ...
  name:      { color: colors.text, fontFamily: typography.bodyMedium, fontSize: typography.size.subheading },
  sub:       { color: colors.textMuted, fontFamily: typography.body, fontSize: typography.size.caption, marginTop: 2, textTransform: 'capitalize' },
  scoreBadge:{ paddingHorizontal: spacing.md, paddingVertical: spacing.xs, borderRadius: radius.full, borderWidth: 1.5 },
  scoreTxt:  { fontFamily: typography.bodyBold, fontSize: typography.size.body },
  ...
  missingTxt:  { color: colors.red, fontFamily: typography.body, fontSize: typography.size.xs },
  ...
  editLabel:  { color: colors.textDim, fontFamily: typography.body, fontSize: typography.size.xs, letterSpacing: 1.5, marginBottom: spacing.xxs },
  editInput:  { backgroundColor: colors.bg, borderRadius: radius.md, borderWidth: 1, borderColor: colors.cardBorder, color: colors.text, fontFamily: typography.body, fontSize: typography.size.body, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, marginBottom: spacing.md, textAlignVertical: 'top' },
  ...
  cuisineChipTxt:  { color: colors.textMuted, fontFamily: typography.body, fontSize: typography.size.caption },
  cuisineChipTxtOn:{ color: colors.primary, fontFamily: typography.bodySemibold },
  ...
  saveBtnTxt: { color: colors.card, fontFamily: typography.bodyMedium, fontSize: typography.size.body },
  ...
  editToggleTxt:{ color: colors.textMuted, fontFamily: typography.body, fontSize: typography.size.caption },
  rejectBtn:    { flex: 1, paddingVertical: spacing.md, alignItems: 'center', borderRightWidth: 1, borderRightColor: colors.cardBorder },
  rejectTxt:    { color: colors.red, fontFamily: typography.bodySemibold, fontSize: typography.size.caption },
  activateBtn:  { flex: 1, paddingVertical: spacing.md, alignItems: 'center' },
  activateTxt:  { color: colors.green, fontFamily: typography.bodySemibold, fontSize: typography.size.caption },
});
