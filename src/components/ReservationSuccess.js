...
const s = StyleSheet.create({
  ...
  title:        { color: colors.text, fontFamily: typography.display, fontSize: typography.size.title, fontWeight: typography.weight.bold, textAlign: 'center' },
  ...
  btnPrimaryTxt:{ color: colors.card, fontSize: typography.size.bodyLg, fontWeight: typography.weight.bold, letterSpacing: 0.5 },
