  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        message={
          target?.isActive
            ? `${target?.fullName} (${target?.email}) ne pourra plus se connecter à TruckSpot tant que son compte reste désactivé.`
            : `${target?.fullName} (${target?.email}) pourra de nouveau se connecter à TruckSpot.`
        }
