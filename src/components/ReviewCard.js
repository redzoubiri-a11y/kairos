...
const s = StyleSheet.create({
  ...
  date:           { color: colors.textDim, fontFamily: typography.body, fontSize: typography.size.caption, marginTop: spacing.xxs },
  stars:          { fontFamily: typography.body, fontSize: typography.size.bodyLg || 15, letterSpacing: 1 },
  ...
  replyBtnTxt:    { color: colors.primary, fontFamily: typography.body, fontSize: typography.size.body },
  replyBox:       { gap: spacing.md },
  replyInput:     { backgroundColor: colors.bg, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.cardBorder, padding: spacing.lg, color: colors.text, fontFamily: typography.body, fontSize: typography.size.body, minHeight: 90, textAlignVertical: 'top' },
