...
const s = StyleSheet.create({
  ...
  couv:       { fontFamily: typography.body, color: colors.text, fontSize: typography.size.bodyLg },
  couvUnit:   { fontFamily: typography.body, color: colors.textDim, fontSize: typography.size.body },
  badge:      { borderRadius: radius.md, borderWidth: 1, paddingHorizontal: spacing.lg, paddingVertical: 6, alignItems: 'center' },
  badgeTxt:   { fontFamily: typography.bodyBold, fontSize: typography.size.caption, letterSpacing: 1.2 },
  ...
  btnTxt:     { fontFamily: typography.bodySemibold, fontSize: typography.size.body, letterSpacing: 0.5 },
