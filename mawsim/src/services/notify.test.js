  ...
  it('produit des gabarits tenant en un seul SMS', () => {
    const rendus = [
      SMS_TEMPLATES.reservation_confirmed({
        salle: 'Complexe Es-Salam', date: '15 Août 2026', ref: 'MAW-2026-0001',
      }),
      SMS_TEMPLATES.deposit_requested({
        pro: 'Résidence Ibn Khaldoun', amount: '30 000', ccp: '0021458796 clé 33', ref: 'MAW-2026-0001',
      }),
      ...
      SMS_TEMPLATES.review_request({
        type: 'mariage', salle: 'Salle El Widad', lien: 'https://mawsim.dz/a/1234',
      }),
      SMS_TEMPLATES.reservation_cancelled({
        salle: 'Espace Andalous', date: '15 Août 2026', ref: 'MAW-2026-0001',
      }),
    ];
