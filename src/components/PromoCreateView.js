...
const s = StyleSheet.create({
  ...
  typeCardOn:    { backgroundColor: colors.primaryDim, borderColor: colors.primary, shadowColor: colors.shadow, shadowOpacity: 0.35, shadowRadius: 10, shadowOffset: { width: 0, height: 0 }, elevation: 5 },
  ...
  percentPillOn: { backgroundColor: colors.noir, borderColor: colors.noir, shadowColor: colors.shadow, shadowOpacity: 0.35, shadowRadius: 8, shadowOffset: { width: 0, height: 0 }, elevation: 4 },
  ...
  activateBtn:   { backgroundColor: colors.noir, borderRadius: radius.xl, padding: spacing.xl, alignItems: 'center', shadowColor: colors.shadow, shadowOpacity: 0.4, shadowRadius: 14, shadowOffset: { width: 0, height: 0 }, elevation: 7 },
  activateBtnTxt:{ color: colors.onDark, fontSize: typography.size.subheading, fontWeight: typography.weight.extrabold },
});
