...
const s = StyleSheet.create({
  ...
  time:    { fontFamily: typography.display, fontSize: typography.size.heading1, letterSpacing: 0.5, width: 56 },
  name:    { fontFamily: typography.bodyMedium, color: colors.text, fontSize: typography.size.bodyLg, marginBottom: spacing.xs },
  ...
  covers:  { fontFamily: typography.body, color: colors.textMuted, fontSize: typography.size.caption },
});
