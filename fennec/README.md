...
fennec/
  ...
  app/                        # PWA réelle, branchée sur src/*.mjs (pas une maquette)
    ...
    bemSprint.html/.mjs        # BEM Sprint — BS1-BS4 (?week=1..4 ou onglets), vrai écran — voir plus bas
    bemSprintBS1-4.json        # texte support + 7 items par semaine, écrits à la main (pas générés)
...
**BEM Sprint — quatre semaines réelles (BS1 à BS4).** `fennec/app/bemSprint.html`
...
les onglets BS1 à BS4 en haut de l'écran (rechargent la page avec le
...
contexte, préposition, article, question tag, connecteur logique.
Lien retour vers
...
avant d'investir dans l'une des deux architectures. BS5-BS8 ne sont pas
intégrés. Validé en navigateur réel : score exact (7/7 sur BS1 à BS4
