...
const BASE = `
  * { box-sizing: border-box; }
  ...
  h1 { font-size: 15px; font-weight: 500; margin: 0 0 4px; letter-spacing: .01em; }
  .intro { font-size: 12px; color: var(--c-warmGray); margin: 0 0 22px; max-width: 62ch; line-height: 1.5; }
  h2 { font-size: 11px; font-weight: 500; text-transform: uppercase; letter-spacing: .07em;
  ...
  .jour--selectionne { background: var(--c-primary); color: var(--c-onPrimary); font-weight: 500; border-color: var(--c-primary); }
...
// 1. Couleurs
{
  ...
  const pastille = (nom, valeur, fond) => {
    ...
    return `<div style="width:150px">
      ...
      <div style="font-size:11px;font-weight:500;margin-top:6px">${nom}</div>
          ...
          <div class="carte carte--plate">
            ${['Période', 'Statut', 'Montant']
              ...
              <div style="display:flex;justify-content:space-between;padding:12px 16px;font-size:14px">
                ...
                <span style="${i === 2 ? 'color:var(--c-primaryInk);font-weight:500' : ''}">${['Septembre 2026', 'Payée', '500 DA'][i]}</span>
              </div>`
              )
              .join('')}
          </div>
        ...
        ${[
          ...
          <div style="width:224px;border:1px solid var(--c-border);border-radius:var(--r-xl);overflow:hidden;background:var(--c-surface)">
            ...
            <div style="padding:12px">
              ...
              <div style="font-size:14px;color:var(--c-primaryInk);font-weight:500;margin-top:8px">À partir de ${prix}</div>
