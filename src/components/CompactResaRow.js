...
const s = StyleSheet.create({
  row:     { flexDirection: 'row', alignItems: 'center', gap: spacing.xl, paddingVertical: spacing.xl, paddingHorizontal: spacing.xxl, borderLeftWidth: 3, borderLeftColor: 'transparent', borderBottomWidth: 1, borderBottomColor: alpha(colors.onDark, 0.07) },
  rowDim:  { opacity: 0.4 },
  rowSel:  { backgroundColor: alpha(colors.onDark, 0.06) },
  time:    { fontSize: typography.size.heading1, fontWeight: '300', letterSpacing: 0.5, width: 56 },
  name:    { color: colors.ivory, fontSize: typography.size.bodyLg, fontWeight: typography.weight.medium, marginBottom: spacing.xs },
