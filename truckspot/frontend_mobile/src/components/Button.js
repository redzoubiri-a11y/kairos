...
const VARIANTS = {
  primary: { bg: colors.primary, fg: '#1A1206', border: 'transparent' },
  ...
  dark: { bg: colors.surfaceRaised, fg: colors.textInverse, border: 'transparent' },
};

const SIZES = {
  sm: { paddingVertical: 8, paddingHorizontal: 14, fontSize: 13, icon: 15 },
  md: { paddingVertical: 14, paddingHorizontal: 20, fontSize: 15, icon: 18 },
  lg: { paddingVertical: 17, paddingHorizontal: 24, fontSize: 16, icon: 20 },
};
