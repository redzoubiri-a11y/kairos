...
const s = StyleSheet.create({
  ...
  titleWrap:  { flex: 1 },
  title:      { fontFamily: typography.display, fontSize: typography.size.heading3, fontWeight: typography.weight.bold, color: colors.text, letterSpacing: -0.2 },
  subtitle:   { fontSize: typography.size.caption, color: colors.textDim, marginTop: 3 },
  statusBadge: { flexShrink: 0, paddingHorizontal: spacing.sm, paddingVertical: 5, borderRadius: radius.sm + 2 },
  statusTxt:   { fontSize: typography.size.xs + 0.5, fontWeight: typography.weight.bold, letterSpacing: 0.2 },

  itemsBlock: { marginTop: spacing.lg - 2, gap: spacing.xs + 1 },
  itemRow:    { flexDirection: 'row', alignItems: 'center', gap: spacing.xs },
  itemQty:    { fontSize: typography.size.body, color: colors.textMuted, fontWeight: typography.weight.medium },
  itemName:   { flex: 1, fontSize: typography.size.body, color: colors.text },
  itemPrice:  { fontSize: typography.size.body, color: colors.textMuted },

  noteWrap:   { marginTop: spacing.sm, backgroundColor: colors.tagNeutralBg, borderRadius: radius.sm, padding: spacing.sm },
  noteTxt:    { fontSize: typography.size.caption, color: colors.textMuted },
  ...
  totalLbl:   { fontSize: typography.size.body, color: colors.textMuted },
  totalVal:   { fontFamily: typography.display, fontSize: typography.size.heading3, fontWeight: typography.weight.bold, color: colors.text },
  ...
  cancelTxt:  { fontSize: typography.size.bodyLg - 0.5, fontWeight: typography.weight.semibold, color: colors.red },
  advanceBtn: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: spacing.md + 1, borderRadius: radius.md + 1, backgroundColor: colors.gold },
  advanceBtnOutline: { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: colors.accentSoft },
  advanceTxt: { fontSize: typography.size.bodyLg - 0.5, fontWeight: typography.weight.bold, color: colors.noir },
  advanceTxtOutline: { color: colors.text, fontWeight: typography.weight.semibold },
});
