  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (data.user?.role !== 'ADMIN') {
        setError(
          "Accès refusé : cette console est réservée aux administrateurs. Utilisez l'application mobile AlloTruck avec ce compte."
        );
        return;
      }
    ...
    <div className="login">
      <div className="login__card">
        <div className="login__brand">
          ...
          <div>
            <div className="login__title">AlloTruck</div>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="field">
            ...
            <input
              ...
              placeholder="admin@allotruck.dz"
              value={email}
